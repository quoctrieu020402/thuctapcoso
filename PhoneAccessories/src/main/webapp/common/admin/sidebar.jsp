		...
		<ul class="sidebar-nav" id="sidebar-nav">
			...
			<li class="nav-item"><a class="nav-link collapsed"
				...
				<ul id="components-nav" class="nav-content collapse "
					...
					<li><a href="/admin/category/list"> <i
							class="bi bi-circle"></i><span>Danh Sách</span>
					</a></li>
					<li><a href="/admin/category/add"> <i
			...
			<li class="nav-item"><a class="nav-link collapsed"
				data-bs-target="#forms-nav" data-bs-toggle="collapse" href="#">
					<i class="bi bi-journal-text"></i><span>Sản Phẩm</span><i
					class="bi bi-chevron-down ms-auto"></i>
			</a>
			...
			<li class="nav-item"><a class="nav-link collapsed"
				data-bs-target="#tables-nav" data-bs-toggle="collapse" href="#">
					<i class="bi bi-layout-text-window-reverse"></i><span>Phiếu Nhập</span><i
					class="bi bi-chevron-down ms-auto"></i>
			</a>
				<ul id="tables-nav" class="nav-content collapse "
					data-bs-parent="#sidebar-nav">
					<li><a href="tables-general.html"> <i class="bi bi-circle"></i><span>
				...
				<li class="nav-item"><a class="nav-link collapsed"
				data-bs-target="#tables-nav" data-bs-toggle="collapse" href="#">
					<i class="bi bi-layout-text-window-reverse"></i><span>Phiếu Đặt</span><i
					class="bi bi-chevron-down ms-auto"></i>
			</a>
			<!-- #tables-nav  tables-nav-->
				<ul id="tables-nav" class="nav-content collapse "
					data-bs-parent="#sidebar-nav">
					<li><a href="tables-general.html"> <i class="bi bi-circle"></i><span>
								Danh sách </span>
			...
			<li class="nav-item"><a class="nav-link collapsed"
				...
				<ul id="charts-nav" class="nav-content collapse "
					data-bs-parent="#sidebar-nav">
					<li><a href="charts-chartjs.html"> <i class="bi bi-circle"></i><span>Thêm</span>
					</a></li>
					<li><a href="charts-apexcharts.html"> <i
							class="bi bi-circle"></i><span>Xóa </span>
					</a></li>
					<li><a href="charts-echarts.html"> <i class="bi bi-circle"></i><span>Cập nhật</span>
					</a></li>
				</ul></li>
			<!-- End Charts Nav -->
