...
<link rel="stylesheet"
	href="/templates/user/js/owlcarousel/owl.theme.default.min.css">
...
<link rel="stylesheet"
	href="/templates/user/css/pagination_phantrang.css">
...
<link rel="stylesheet"
	href="<c:url value="/templates/user/css/pagination_phantrang.css"/>" />
	...
	<!-- js -->
	<script src="/templates/user/js/classes.js"></script>
    <script src="/templates/user/js/dungchung.js"></script>
    <script src="/templates/user/js/nguoidung.js"></script>
</head>
<body>
