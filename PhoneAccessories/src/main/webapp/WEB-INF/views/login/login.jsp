...
<link rel="stylesheet" href="/templates/login/access/fonts/icomoon/style.css">

<link rel="stylesheet" href="/templates/login/access/css/owl.carousel.min.css">

<!-- Bootstrap CSS -->
<link rel="stylesheet" href="/templates/login/access/css/bootstrap.min.css">
		...
		<div class="container">
			<div class="row">
				<div class="col-md-6 order-md-2">
					<img src="/templates/login/access/images/undraw_file_sync_ot38.svg" alt="Image"
						class="img-fluid">
				</div>
						...
						<div class="col-md-8">
							...
							<form:form action="login" method="post" modelAttribute="account">
								...
								<div class="form-group last mb-4">
									...
									<form:input path="pasword" type="password" class="form-control"
										id="password" />
								...
								<a href="/signin" class="btn text-white btn-block btn-primary">Đăng kí</a>

									
									<span
									class="d-block text-left my-4 text-muted"> Hoặc đăng nhập với
									</span>
